...
?>
            <div class="fwgs-image espai_interior"<?php if ($styles) { ?> style="<?php echo implode('', $styles); ?>"<?php } ?>><a href="<?php echo $link; ?>"><img src="<?php echo JURI :: base(false).JFHelper :: getFileFilename($this->row, 'th'); ?>" alt="<?php echo JFHelper :: escape($this->row->name); ?>" <?php echo JFHelper :: getCenteringStyle($this->row, 'th', 0, $this->gallery_image_height); ?>/></a></div>
<?php
